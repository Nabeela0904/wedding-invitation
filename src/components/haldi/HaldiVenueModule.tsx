  ...
  return (
    <section className="relative z-10 bg-cream px-5 pb-6 pt-4 sm:px-8">
      ...
      <div className="mx-auto mt-6 flex max-w-lg justify-end py-4 pl-3 pr-0 sm:py-5 sm:pl-6 sm:pr-0">
        <a
          href="/nikah"
          className="inline-flex translate-x-1 items-center justify-center rounded-full border border-marigold/45 bg-gradient-to-r from-marigold to-saffron px-8 py-2.5 font-sans text-[11px] font-semibold uppercase tracking-[0.22em] text-cream shadow-gold transition-[transform,box-shadow] duration-300 hover:scale-[1.03] hover:shadow-gold-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-marigold/50 active:scale-[0.97] sm:translate-x-2"
        >
          Nikah
        </a>
      </div>
