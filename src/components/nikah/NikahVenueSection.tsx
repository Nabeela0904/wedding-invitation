...
export default function NikahVenueSection() {
  ...
  return (
    ...
    >
      <div className="nikah-glass rounded-3xl p-6 text-center sm:p-8">
        <motion.h2
        ...
        <motion.button
          type="button"
          variants={fadeSlideUp}
          className="group relative mx-auto mt-8 block rounded-2xl border-2 border-metallic-gold/60 bg-white/60 p-3 shadow-nikah-gold transition-transform will-change-transform focus:outline-none focus-visible:ring-2 focus-visible:ring-metallic-gold/50"
          onClick={() => setRevealed((v) => !v)}
          onMouseEnter={() => setRevealed(true)}
          onMouseLeave={() => setRevealed(false)}
          aria-label="Venue QR code — tap to open Google Maps"
        >
