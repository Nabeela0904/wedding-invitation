...
/** Minimal luxury line ornament for Walima split hero */
export default function WalimaGeometricAccent() {
  return (
    <div className="relative flex flex-col items-center justify-center gap-3 py-6 lg:py-0">
      <motion.div
        className="h-16 w-px bg-gradient-to-b from-transparent via-metallic-gold to-transparent sm:h-20"
      ...
      >
        <svg viewBox="0 0 80 80" className="h-full w-full">
          ...
          <circle cx="40" cy="40" r="18" fill="none" stroke="#064E3B" strokeWidth="0.5" opacity="0.35" />
        </svg>
      </motion.div>
