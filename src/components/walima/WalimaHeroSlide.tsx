  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(251,243,232,0.95) 0%, rgba(251,243,232,0.62) 55%, transparent 100%)",
        }}
        aria-hidden
      />
      ...
      <motion.p
        ...
        lang="ar"
        dir="rtl"
        className="relative font-amiri text-[clamp(1.75rem,6vw,2.85rem)] leading-relaxed text-metallic-gold drop-shadow-[0_2px_16px_rgba(251,243,232,0.9)]"
      >
      ...
      <motion.p
        variants={fadeSlideUp}
        className="relative mt-8 font-display text-[clamp(1rem,3.2vw,1.45rem)] font-medium uppercase tracking-[0.14em] text-emerald drop-shadow-[0_1px_12px_rgba(251,243,232,0.85)]"
      >
        {WALIMA_EVENT.hosts}
      </motion.p>
      ...
      <motion.p
        variants={fadeSlideUp}
        className="relative mx-auto mt-6 max-w-2xl font-sans text-[10px] font-medium uppercase tracking-[0.22em] text-emerald/75 sm:text-[11px]"
      >
      ...
      <div className="relative mt-12 grid w-full max-w-5xl grid-cols-1 items-center gap-8 lg:grid-cols-[1fr_auto_1fr] lg:gap-4">
        <motion.div variants={fadeSlideUp} className="lg:text-right">
          <h1 className="font-display text-[clamp(1.25rem,3.8vw,1.85rem)] font-semibold uppercase leading-tight tracking-[0.1em] text-emerald">
