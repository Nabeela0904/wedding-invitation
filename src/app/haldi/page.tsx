...
export default function HaldiPage() {
  return (
    <main className="relative min-h-screen overflow-x-hidden">
      ...
      <Link
        href="/"
        className="fixed left-4 top-4 z-50 rounded-full border border-marigold/30 bg-white/60 px-4 py-2 font-sans text-xs font-medium text-gold backdrop-blur-md transition-opacity hover:opacity-90 sm:left-6 sm:top-6 sm:text-sm"
      >
        ← Wedding Home
      </Link>
